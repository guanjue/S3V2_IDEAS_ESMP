...
###### your output folder
output_dir='/app/S3V2_IDEAS_ESMP/test_data/hg38wg_outputs/'
###### the absolute path to the your modified "metadata.for_master_peak_calls.txt" file
metadata='/app/S3V2_IDEAS_ESMP/test_data/metadata.forEScall.hg38wg.txt'
###### The output name
...
GENOMESIZES='/app/S3V2_IDEAS_ESMP/genomesize/hg38.chrom.1_22XY.sizes'
###### blacklist (can be found in the "S3V2_IDEAS_ESMP/blacklist/" folder)
BLACK='/app/S3V2_IDEAS_ESMP/blacklist/hg38-blacklist.v2.bed'
