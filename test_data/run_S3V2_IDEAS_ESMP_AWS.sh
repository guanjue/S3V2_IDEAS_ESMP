...
script_dir='/home/admin/app/git/S3V2_IDEAS_ESMP/bin/'
###### your output folder
output_dir='/home/admin/app/git/S3V2_IDEAS_ESMP/test_data/outputs/'
###### the absolute path to the your modified "metadata.for_master_peak_calls.txt" file
metadata='/home/admin/app/git/S3V2_IDEAS_ESMP/test_data/metadata.forEScall_AWS.txt'
###### The output name
...
GENOMESIZES='/home/admin/app/git/S3V2_IDEAS_ESMP/genomesize/mm10.chrom.chr11.fortest.sizes'
###### blacklist (can be found in the "S3V2_IDEAS_ESMP/blacklist/" folder)
BLACK='/home/admin/app/git/S3V2_IDEAS_ESMP/blacklist/mm10-blacklist.v2.bed'
