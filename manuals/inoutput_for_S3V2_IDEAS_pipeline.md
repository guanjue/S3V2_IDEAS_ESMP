...
##### The "test_S3V2_IDEAS_package.para" file can also be used as the prior information for new IDEAS runs. It can be input by the "other_parafile" option in the "run_S3V2_IDEAS_ESMP.sh" file
