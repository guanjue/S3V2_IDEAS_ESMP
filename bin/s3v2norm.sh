...
while read -r line; do
   ...
   command="Rscript ${script_folder}/s3v2norm_IDEAS.R ${f[0]} ${f[1]} ${outfile} ${fdr_thresh} ${exp_win} F F ${rank_lim} ${upperlim} ${lowerlim} ${p_method} ${common_pk_binary} ${common_bg_binary} ${allpk_binary}"
